...
class ExameUpdateUseCase(ExameUpdateInterface):
    ...
    def update(self, exame_id: int, exame: Exame) -> Dict:
        ...
        # update(id, tipo_exame, data_exame, paciente_id, medico_id, resultado, status)
        self.exame_repository.update(
            exame_id,
            exame.tipo_exame,
            exame.data_exame,
            exame.paciente_id,
        ...
        return self.__format_response(exame_id, exame)
    ...
    def __format_response(self, exame_id: int, exame: Exame) -> Dict:
        return {
            "type": "Exame",
            "id": exame_id,
            "attributes": {
