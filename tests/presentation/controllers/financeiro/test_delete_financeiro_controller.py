...
from tests.data.mock.financeiro.delete_financeiro_spy import FinanceiroDeleteUsecaseSpy
...
def test_handle():
    ...
    usecase_spy = FinanceiroDeleteUsecaseSpy()
    controller = FinanceiroDeleteController(usecase_spy)
