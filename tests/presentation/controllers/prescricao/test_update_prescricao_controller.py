from tests.data.mock.prescricao.update_prescricao_spy import PrescricaoUpdateUsecaseSpy
...
def test_handle():
    ...
    usecase_spy = PrescricaoUpdateUsecaseSpy()
    controller = PrescricaoUpdateController(usecase_spy)
