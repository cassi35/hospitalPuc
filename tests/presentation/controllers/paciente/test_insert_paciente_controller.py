...
from tests.data.mock.paciente.insert_paciente_spy import PacienteInsertUsecaseSpy
...
def test_handle():
    ...
    usecase_spy = PacienteInsertUsecaseSpy()
    controller = PacienteInsertController(usecase_spy)
